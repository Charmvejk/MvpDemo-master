package com.example.azheng.rxjavamvpdemo.third.widget;
...
import com.example.azheng.rxjavamvpdemo.third.widget.zoonview.PhotoView;
import com.example.azheng.rxjavamvpdemo.third.widget.zoonview.PhotoViewAttacher;
import com.example.azheng.rxjavamvpdemo.third.widget.zoonview.ViewHolderRecyclingPagerAdapter;
...
//        }
        ...
        if(path.startsWith("http")) {
            ...
            dialog.show();
            JImageShowUtil.displayImageScale(path, "", holder.mImageView, null,getContext(),dialog);
        }else{
            int source = 0;
            try{
