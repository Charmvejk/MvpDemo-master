...
import com.example.azheng.rxjavamvpdemo.presenter.YueyePresenter;

import java.util.ArrayList;
import java.util.List;

public class CarFragment extends BaseMvpFragment<YueyePresenter> implements MainContract.View {
    ...
    @Override
    public YueyePresenter createPresenter() {
        return new YueyePresenter();
    }
