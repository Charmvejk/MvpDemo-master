...
import com.example.azheng.rxjavamvpdemo.bean.JPhotosInfos;
import com.example.azheng.rxjavamvpdemo.third.beans.PhotoInfo;
import com.example.azheng.rxjavamvpdemo.third.widget.GFViewPager;
import com.example.azheng.rxjavamvpdemo.third.widget.PhotoPreviewAdapter;
import com.example.azheng.rxjavamvpdemo.util.JAnimationUtil;
import com.example.azheng.rxjavamvpdemo.util.JBitmapUtils;
import com.example.azheng.rxjavamvpdemo.util.JStringUtils;
import com.example.azheng.rxjavamvpdemo.util.JWindowUtil;
...
public class JBrowseImgActivity extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jbrowse_img);
        initData();
        initView();
    }
